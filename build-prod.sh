...
docker tag sjc.vultrcr.com/phippsytech/prodis-api:latest sjc.vultrcr.com/phippsytech/prodis:$CURRENT_DATE
...
docker tag sjc.vultrcr.com/phippsytech/prodis-app:latest sjc.vultrcr.com/phippsytech/prodis:$CURRENT_DATE
