...
class DeleteTimes {
    ...
    public function __invoke($data) {
        ...
        if ($start_timestamp < $current_timestamp ) {
            return ["http_code"=>400, "error_message"=>"Times before the end of the current week cannot be deleted.","current_timestamp"=>$current_timestamp, "end_timestamp"=>$end_timestamp ,"end_date"=>$end_date, "start_date"=>$start_date];
        }
