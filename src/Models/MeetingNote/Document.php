<?php
namespace NDISmate\Models\MeetingNote;
...
class Document extends BaseModel {
    ...
    public function __invoke(ServerRequestInterface $request, ResponseInterface $response, array $args): ResponseInterface {
        ...
        $this->CRUD = new CRUD("meetingnotedocument", [
            'id' => [v::numericVal()],
            'meetingnote_id' => [v::numericVal()],
        ...
        $this->actions = [
            ["uploadMeetingNoteDocument", "upload", true, [] ],
            ["listMeetingNoteDocuments", "getAllDocuments", true, [] ],
            ["deleteMeetingNoteDocument", "deleteDocument", true, [] ],
        ];
    ...
    function getAllDocuments($data){
        ...
        $beans = R::findAll( 'meetingnotedocuments', 'meetingnote_id = :meetingnote_id', [':meetingnote_id'=>$data['meetingnote_id']] );
    ...
    function upload($data){
        ...
        $this->create([
            "meetingnote_id" => $data['meetingnote_id'],
            "name" => $data['name'],
