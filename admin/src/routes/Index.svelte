<script>
    ...
    import { UserStore, RolesStore, BreadcrumbStore } from "@shared/stores.js";
...
<div class="text-white p-2 my-2 px-4">
    <div
        class="text-2xl text-white tracking-tight font-fredoka-one-regular"
    >
        Hi {$UserStore.first_name}!
    </div>

    <!-- <div class="text-slate-800 text-sm">
        We're working hard to improve usability. If you have any issues
        or suggestions please let admin know.
    </div> -->
</div>
