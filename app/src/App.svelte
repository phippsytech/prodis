<script>
    // import "./Overlays/consoleStore";
    // import Console from "./Overlays/Console.svelte";
    import Router from "svelte-spa-router";
    import routes from "./routes";
    import Guard from "@shared/appsec/Guard.svelte";
    import Offline from "./Layout/Offline.svelte";
    import VersionCheck from "./Layout/VersionCheck.svelte";
    ...
    import InvoiceBar from "./Layout/BottomNav/InvoiceBar.svelte";
