...
{#if modal.show}
  ...
  >
    ...
    <div class="fixed inset-0 z-10 overflow-y-auto">
      ...
      >
        <div
          class="relative overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 w-full sm:max-w-xl md:max-w-lg"
        >
          <div class="bg-white py-3 px-4">
            <div class="">
              <div class="mt-1 text-left">
                ...
                {#if modal.description}<div class="text-xs">
                    {modal.description}
                  </div>{/if}
