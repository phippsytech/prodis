    ...
    >
        <div id="spinner">
            <svg
                ...
                width="81.25px"
                height="71.55px"
                viewBox="0 0 10.862001 9.5649996"
                version="1.1"
                id="svg239145"
            ...
            >
                ...
                <path
                    ...
                    style="fill:#4f46e5;fill-opacity:1;stroke:none;stroke-width:0.269012;stroke-linecap:round;stroke-linejoin:round;stroke-miterlimit:4;stroke-dasharray:none;stroke-opacity:1;paint-order:fill markers stroke"
        ...
        {#if spinner.message}<div class="text-gray-600 py-5">
                {spinner.message}
            </div>{/if}
    </div>
{/if}
