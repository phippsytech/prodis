...
<Container>
  ...
  <div>
    Current AHRPA registration Birth certificate citizenship certificate current
    passport expired passport that was not cancelled and was current within the
  ...
  <div>Student card issued by an Australian tertiary education institution</div>
</Container>
...
<Container>
  ...
  <div>
    To demonstrate ongoing professional development. A professional development
    plan is also advantageous
  </div>
</Container>
...
<Container>
  ...
  <div>
    ...
    contractors in place, they require their own insurance, and you will need a
    copy on file.
  </div>
</Container>

<Container>
  <div class="font-semibold">Comprehensive Car Insurance and Registration</div>
  <div>
    Copies of registration and comprehensive car insurance policy for any staff
    that tranpsorts participants in ther car.
  </div>
</Container>
...
<Container>
  ...
  <div>
    This document verifies that the employee underwent an orientation and has a
...
<Container>
  ...
  <div>
    Ensure you have evidence of any staff training completed, including in-house
    traning for: complaints management, indident management, risk management
  </div>
</Container>
...
<Container>
  ...
  <div>
    Ensure you have evidence that staff undergo annual performance management
    reviews. the position description will be reviewed, performance discussed,
    and a traning needs analysis completed to direct the staff training plan.
  </div>
</Container>
...
<Container>
  ...
  <div>
    If an employee has declared a conflict of interest, a completed conflict of
    interest declartion mnust be on file.
  </div>
</Container>
...
<Container>
  ...
  <div>
    Every employee must have a signed privacy and confidentiality agreement on
    file
  </div>
</Container>
