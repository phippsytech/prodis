<script>
  ...
  import ParticipantAccessControl from "../Users/ParticipantAccessControl.svelte";
  ...
  let signature_request_id = params.signature_request_id;
  ...
  BreadcrumbStore.set({
    path: [{ name: "Signature Requests", url: "/signaturerequests" }],
  });
...
<div
  class="text-2xl text-indigo-700 tracking-tight font-fredoka-one-regular px-2 mt-2"
>
