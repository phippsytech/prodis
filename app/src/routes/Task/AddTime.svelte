<script>
    ...
    function add(tasktime) {
        // console.log(tasktime)
        if (
            tasktime.client_id == "Choose client" ||
            tasktime.client_id == null
        ) {
...
<Container>
    ...
    {#if assign_to_participant}
        Note: This does not bill the participant. It just records that admin
        time was spent on the participant. This information helps us to better
        understand the time spent on each participant.
