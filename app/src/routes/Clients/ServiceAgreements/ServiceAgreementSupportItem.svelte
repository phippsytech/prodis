...
<ul class=" bg-white rounded-xl border border-b w-full text-slate-800 mb-4">
  <li
    class="bg-indigo-900 text-white text-sm rounded-t-md group flex justify-between items-center px-4 py-2 focus:outline-none focus:ring-0 focus:bg-indigo-600 focus:text-slate-600 transition duration-500 border-b border-indigo-100 w-full"
  >
    Awaiting Signature
  </li>
    ...
    <div class="staff-member">
      <div class="flex text-sm inline">
        <a
          ...
          ><DocumentTextIcon class="h-4 w-4 inline mr-1" /> Service Agreement Awaiting
          Signature - 9 May 2024 to 29 Sept 2024</a
  ...
  <Role roles={["serviceagreement.modify"]}>
    <li
      class="px-4 py-2 border-b border-indigo-100 w-full text-slate-400 cursor-default text-xs"
    >
      <button
        on:click={() => toggleGenerator()}
        class="text-indigo-600 cursor-pointer hover:underline"
        ><PlusIcon class="w-4 h-4 inline" /> Generate Service Agreement</button
      >

      {#if showGenerator}
        <ul class=" bg-white rounded-xl border border-b text-slate-800 mb-2">
          <li
            class=" text-white text-sm rounded-t-md group flex justify-between items-center px-2 py-2 focus:outline-none focus:ring-0 focus:bg-indigo-600 focus:text-slate-600 transition duration-500 border-b border-indigo-100 w-full"
          >
            <div class="flex justify-between items-center w-full gap-x-2">
              <span>Create New Service Agreement</span>
              <a
                class="flex p-1 rounded-full text-center text-sm font-semibold text-white transition duration-300 cursor-pointer"
