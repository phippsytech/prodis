...
<div class="text-2xl sm:truncate sm:text-3xl sm:tracking-tight font-fredoka-one-regular mb-4" style="color:#220055;">Note</div>

<StaffTimeDate bind:value={form} {readOnly} />
    
<textarea placeholder="write note here" class="rounded border py-0 p-1.5 border-gray-300  focus:border-blue-600 focus:outline-none w-full" style="height:150px" bind:value={form.note} {readOnly} autofocus ></textarea>
