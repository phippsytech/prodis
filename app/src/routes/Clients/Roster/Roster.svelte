<script>
  ...
  function editShift(shift_id) {
    jspa("/SIL/House/Roster", "getShift", { id: shift_id }).then((result) => {
      ...
      <div class="flex">
        ...
        <div class="ml-3 flex-1 md:flex md:justify-between">
          <p class="text-sm text-blue-700">
            <b>Roster is in read-only mode.</b> You cannot edit the roster using
            a shared login.
          </p>
        </div>
      </div>
...
<style>
  :global(.ec-content .ec-time, .ec-content .ec-line) {
